...
<center>
<br>
<img style="width:10%;" src="\static\assets\img\blog\project\withMyPet\footprint.png"><br><br><img style="width:60%;" src="\static\assets\img\blog\project\withMyPet\team.jpg"><br><br><br>
<p style="font-size:1.8rem;">: <b>위드마이펫</b> 은 총 6명의 팀원이 함께 구현한 파이널 프로젝트로,<br>&nbsp; 반려인들이 쉽게 동네 친구를 구하고 쇼핑, 커뮤니티 등 다양한 서비스를 사용할 수 있는<br>반려동물 통합 웹 애플리케이션 입니다.</p><br><br><br>
...
<p><p>1-1 산책 목록</p><br>
<p><iframe style="width:100%"  src="\static\assets\img\blog\project\withMyPet\1-walklist.gif" frameborder='0' scrolling='no' width='640px' height='360px' style='-webkit-backface-visibility: hidden;-webkit-transform: scale(1);' ></iframe></p><br><br>
...
<iframe style="width:100%" src="\static\assets\img\blog\project\withMyPet\3-share2.gif" frameborder='0' scrolling='no' width='640px' height='360px' style='-webkit-backface-visibility: hidden;-webkit-transform: scale(1);' ></iframe><br>
...
<iframe style="width:100%" src="\static\assets\img\blog\project\withMyPet\8-socket.gif" frameborder='0' scrolling='no' width='640px' height='360px' style='-webkit-backface-visibility: hidden;-webkit-transform: scale(1);' ></iframe><br><br><br>
<p style="margin-bottom:5%;">- CRUD : 작성, 수정, 삭제, 회원 데이터 연동<br>- Kakao 지도, 공유 API<br></p>
